...
window.ASSETS = [
  ...
  { id: '004', type: 'card', name: 'Radar Dome', category: 'Head · Sensor', cost: 3, atk: 0, def: 2, spd: 0, eng: 0, rng: 7, hp: 4,
    effect: 'Unlocks: Precision actions. Sensor dodge chance increased to 35%.', flavor: 'Nothing moves unseen.' },
  ...
  { id: '009', type: 'card', name: 'Repair Arm', category: 'Arm · Repair', cost: 2, atk: 2, def: 3, spd: 1, eng: 5, rng: 0, hp: 4,
    effect: 'Unlocks: Repair actions.', flavor: 'Tightens its own bolts.' },
  { id: '010', type: 'card', name: 'Gatling Arm', category: 'Arm · Weapon', cost: 4, atk: 8, def: 0, spd: 0, eng: -0, rng: 2, hp: 0,
    effect: 'Unlocks: Weapon, Strike actions. Strike actions deal +2 bonus damage.', flavor: 'Spray and pray.' },
  ...
  { id: '014', type: 'card', name: 'Anchor Legs', category: 'Leg · Armor', cost: 3, atk: 2, def: 6, spd: 0, eng: 0, rng: 0, hp: 6,
    effect: 'Unlocks: Defense actions. +3 DEF when defending against Strikes.', flavor: 'Rooted to the arena floor.' },
  ...
  { id: '030', type: 'card', name: 'Coolant Mesh', category: 'Material', cost: 1, atk: 0, def: 0, spd: 0, eng: 12, rng: 0, hp: 5,
    effect: 'Material — slot-free. +12 ENG, +5 HP.', flavor: 'Never overheats.' },
  { id: '031', type: 'card', name: 'Reflective Coat', category: 'Material', cost: 1, atk: 1, def: 2, spd: 0, eng: 0, rng: 4, hp: 2,
    effect: 'Material — slot-free. +4 RNG, +2 DEF.', flavor: 'Lasers bounce right off.' },
  { id: '032', type: 'card', name: 'Shock Absorber', category: 'Material', cost: 1, atk: 0, def: 1, spd: 4, eng: 0, rng: 0, hp: 6,
    effect: 'Material — slot-free. +4 SPD, +6 HP.', flavor: 'Takes the hit and keeps going.' },
  ...
  { id: '033', type: 'card', name: 'Tesla Coil', category: 'Hardpoint · Weapon', cost: 3, atk: 7, def: 0, spd: 1, eng: 0, rng: 2, hp: 1,
    effect: 'Unlocks: Weapon actions. Attacks arc to ignore 50% of DEF.', flavor: 'Zzzzap.' },
  { id: '034', type: 'card', name: 'EMP Emitter', category: 'Hardpoint · Sensor', cost: 3, atk: 0, def: 1, spd: 3, eng: 0, rng: 2, hp: 2,
    effect: 'Unlocks: Precision actions. Enemy ENG costs increase by 2 for one round.', flavor: 'Fries their circuits.' },
  { id: '035', type: 'card', name: 'Grapple Hook', category: 'Arm · Strike', cost: 2, atk: 4, def: 1, spd: 3, eng: 0, rng: 3, hp: 1,
    effect: 'Unlocks: Strike actions. Pull an out-of-range opponent into melee range.', flavor: 'Get over here.' },
  { id: '036', type: 'card', name: 'Phase Shifter', category: 'Leg · Speed', cost: 3, atk: 0, def: 0, spd: 5, eng: 3, rng: 0, hp: 1,
    effect: 'Unlocks: Speed actions. Once per fight, auto-dodge any single attack.', flavor: 'Here, not here, here again.' },
  { id: '037', type: 'card', name: 'Mortar Pod', category: 'Hardpoint · Weapon', cost: 3, atk: 5, def: 0, spd: 0, eng: 0, rng: 6, hp: 1,
    effect: 'Unlocks: Weapon actions. Attacks from any range ignore retaliation.', flavor: 'From above.' },
  { id: '038', type: 'card', name: 'Medic Drone', category: 'Hardpoint · Repair', cost: 2, atk: 0, def: 2, spd: 1, eng: 5, rng: 0, hp: 3,
    effect: 'Unlocks: Repair actions. Heal 3 HP at the start of each turn.', flavor: 'A tiny friend with a welder.' },
  { id: '039', type: 'card', name: 'Kinetic Fist', category: 'Arm · Strike', cost: 3, atk: 7, def: 0, spd: 2, eng: 0, rng: 0, hp: 1,
    effect: 'Unlocks: Strike actions. Damage increases with SPD difference.', flavor: 'Speed becomes power.' },
  ...
  { id: '213', type: 'tile', name: 'Flanking Maneuver', category: 'Speed', cost: 4,
    effect: 'Gain +3 SPD this round. Next Strike costs 0 ENG. Requires: Speed unlocked.', flavor: 'Now you see it.' },
  { id: '214', type: 'tile', name: 'Barrage', category: 'Weapon', cost: 9,
    effect: 'Deal ATK to all enemy systems. Enemy DEF is halved for this attack. Requires: Weapon unlocked. Min ENG: 18.', flavor: 'Everything. Fire everything.' },
  { id: '215', type: 'tile', name: 'Recharge', category: 'Engine', cost: 0,
    effect: 'Gain 12 ENG. Requires: Engine unlocked.', flavor: 'Deep breath.' },
];
