...
window.ASSETS = [
  ...
  { id: '041', type: 'card', name: 'Neuro-Link Crown', category: 'Head · Command', cost: 3, atk: 1, def: 2, spd: 4, eng: 6, rng: 2, hp: 3,
    effect: 'Unlocks: Command, Precision actions. Reaction cards cost 1 less ENG.', flavor: 'Thinks faster than you act.' , image: 'assets/images/cards/041-pixel-art-16-bit.jpg'},
  { id: '042', type: 'card', name: 'Infrared Visor', category: 'Head · Sensor', cost: 2, atk: 0, def: 1, spd: 2, eng: 0, rng: 6, hp: 1,
    effect: 'Unlocks: Precision actions. Ignores sensor jammer effects.', flavor: 'Sees through the noise.' , image: 'assets/images/cards/042-pixel-art-16-bit.jpg'},
  { id: '043', type: 'card', name: 'Battle Computer', category: 'Head · Command', cost: 4, atk: 3, def: 1, spd: 2, eng: 10, rng: 3, hp: 2,
    effect: 'Unlocks: Command, Boost actions. +2 bonus damage on all Strikes.', flavor: 'Calculates every angle.' , image: 'assets/images/cards/043-pixel-art-16-bit.jpg'},
  { id: '044', type: 'card', name: 'Echo Locator', category: 'Head · Sensor', cost: 2, atk: 0, def: 0, spd: 3, eng: 0, rng: 8, hp: 0,
    effect: 'Unlocks: Precision actions. Sensor dodge chance +5%.', flavor: 'Pings the darkness.' , image: 'assets/images/cards/044-pixel-art-16-bit.jpg'},
  { id: '045', type: 'card', name: 'War Horn Antenna', category: 'Head · Command', cost: 3, atk: 2, def: 0, spd: 5, eng: 4, rng: 1, hp: 1,
    effect: 'Unlocks: Command actions. First Strike each round costs half ENG.', flavor: 'Sounds the charge.' , image: 'assets/images/cards/045-pixel-art-16-bit.jpg'},

  // Arms
  { id: '046', type: 'card', name: 'Plasma Cutter', category: 'Arm · Weapon', cost: 4, atk: 8, def: 0, spd: 1, eng: 0, rng: 1, hp: 0,
    effect: 'Unlocks: Weapon actions. Ignores 3 DEF on attack.', flavor: 'Slices through anything.' , image: 'assets/images/cards/046-pixel-art-16-bit.jpg'},
  { id: '047', type: 'card', name: 'Magnetic Fist', category: 'Arm · Strike', cost: 3, atk: 6, def: 2, spd: 2, eng: 0, rng: 0, hp: 2,
    effect: 'Unlocks: Strike actions. Pulls enemy into melee range.', flavor: 'Opposites attract — violently.' , image: 'assets/images/cards/047-pixel-art-16-bit.jpg'},
  { id: '048', type: 'card', name: 'Cryo Blaster', category: 'Arm · Weapon', cost: 4, atk: 5, def: 1, spd: 0, eng: 2, rng: 4, hp: 1,
    effect: 'Unlocks: Weapon actions. Enemy SPD -2 for one turn on hit.', flavor: 'Freezes their circuits.' , image: 'assets/images/cards/048-pixel-art-16-bit.jpg'},
  { id: '049', type: 'card', name: 'Bunker Shield', category: 'Arm · Defense', cost: 4, atk: 0, def: 10, spd: 0, eng: 0, rng: 0, hp: 4,
    effect: 'Unlocks: Defense actions. Cannot attack the turn you defend.', flavor: 'Wall mode engaged.' , image: 'assets/images/cards/049-pixel-art-16-bit.jpg'},
  { id: '050', type: 'card', name: 'Chain Fist', category: 'Arm · Strike', cost: 3, atk: 7, def: 1, spd: 3, eng: 0, rng: 0, hp: 0,
    effect: 'Unlocks: Strike actions. Hits twice if SPD beats enemy by 2+.', flavor: 'Whirring teeth and flying sparks.' , image: 'assets/images/cards/050-pixel-art-16-bit.jpg'},

  // Legs
  { id: '051', type: 'card', name: 'Hover Pads', category: 'Leg · Speed', cost: 3, atk: 0, def: 0, spd: 7, eng: 4, rng: 0, hp: 0,
    effect: 'Unlocks: Speed actions. Immune to ground-based interrupts.', flavor: 'Never touches the ground.' , image: 'assets/images/cards/051-pixel-art-16-bit.jpg'},
  { id: '052', type: 'card', name: 'Spider Legs', category: 'Leg · Speed', cost: 3, atk: 1, def: 2, spd: 5, eng: 0, rng: 0, hp: 3,
    effect: 'Unlocks: Speed actions. Can climb — SPD not reduced by terrain.', flavor: 'Eight legs, zero fear.' , image: 'assets/images/cards/052-pixel-art-16-bit.jpg'},
  { id: '053', type: 'card', name: 'Fortress Treads', category: 'Leg · Armor', cost: 5, atk: 0, def: 8, spd: 0, eng: 0, rng: 0, hp: 15,
    effect: 'Unlocks: Defense actions. +5 DEF when below 50% HP.', flavor: 'Digs in and dares you.' , image: 'assets/images/cards/053-pixel-art-16-bit.jpg'},
  { id: '054', type: 'card', name: 'Blink Drive Legs', category: 'Leg · Speed', cost: 4, atk: 0, def: 0, spd: 8, eng: 3, rng: 0, hp: 1,
    effect: 'Unlocks: Speed actions. Once per round, teleport to avoid an attack (10% chance).', flavor: 'Now you see me.' , image: 'assets/images/cards/054-pixel-art-16-bit.jpg'},
  { id: '055', type: 'card', name: 'Piston Stompers', category: 'Leg · Armor', cost: 3, atk: 3, def: 4, spd: 1, eng: 0, rng: 0, hp: 8,
    effect: 'Unlocks: Defense actions. Stomp deals ATK as bonus damage once per round.', flavor: 'Every step is an earthquake.' , image: 'assets/images/cards/055-pixel-art-16-bit.jpg'},

  // Cores
  { id: '056', type: 'card', name: 'Dark Matter Core', category: 'Core · Engine', cost: 5, atk: 5, def: 3, spd: 1, eng: 25, rng: 0, hp: 5,
    effect: 'Unlocks: Engine, Boost actions. All ENG costs reduced by 1.', flavor: 'Infinite, hungry, awake.' , image: 'assets/images/cards/056-pixel-art-16-bit.jpg'},
  { id: '057', type: 'card', name: 'Plasma Heart', category: 'Core · Boost', cost: 4, atk: 6, def: 0, spd: 2, eng: 8, rng: 0, hp: 0,
    effect: 'Unlocks: Boost actions. Overheats — next attack after Overload deals +5 extra.', flavor: 'Burns at 10,000 degrees.' , image: 'assets/images/cards/057-pixel-art-16-bit.jpg'},
  { id: '058', type: 'card', name: 'Regen Core', category: 'Core · Repair', cost: 4, atk: 0, def: 2, spd: 1, eng: 6, rng: 0, hp: 15,
    effect: 'Unlocks: Repair actions. Passive: heal 3 HP at the start of each turn.', flavor: 'Heals faster than you can break it.' , image: 'assets/images/cards/058-pixel-art-16-bit.jpg'},
  { id: '059', type: 'card', name: 'Quantum Core', category: 'Core · Engine', cost: 5, atk: 3, def: 3, spd: 3, eng: 20, rng: 0, hp: 10,
    effect: 'Unlocks: Engine, Speed actions. +5 ENG recharge between rounds instead of +10 if above 50% HP.', flavor: 'Exists in two states at once.' , image: 'assets/images/cards/059-pixel-art-16-bit.jpg'},
  { id: '060', type: 'card', name: 'Void Core', category: 'Core · Engine', cost: 5, atk: 2, def: 1, spd: 0, eng: 30, rng: 0, hp: 2,
    effect: 'Unlocks: Engine actions. All cards cost +1 ENG but deal +5 damage.', flavor: 'Emptiness that fuels destruction.' , image: 'assets/images/cards/060-pixel-art-16-bit.jpg'},

  // Materials (slot-free)
  { id: '061', type: 'card', name: 'Adamant Weave', category: 'Material', cost: 1, atk: 0, def: 6, spd: 0, eng: 0, rng: 0, hp: 10,
    effect: 'Material — slot-free. +6 DEF, +10 HP.', flavor: 'Threaded from fallen stars.' , image: 'assets/images/cards/061-pixel-art-16-bit.jpg'},
  { id: '062', type: 'card', name: 'Overcharge Coating', category: 'Material', cost: 1, atk: 3, def: 0, spd: 0, eng: 15, rng: 0, hp: 2,
    effect: 'Material — slot-free. +3 ATK, +15 ENG.', flavor: 'Crackles with static.' , image: 'assets/images/cards/062-pixel-art-16-bit.jpg'},
  { id: '063', type: 'card', name: 'Phase Shift Film', category: 'Material', cost: 1, atk: 0, def: 2, spd: 5, eng: 3, rng: 1, hp: 4,
    effect: 'Material — slot-free. +5 SPD, +2 DEF.', flavor: 'Barely there. Hard to hit.' , image: 'assets/images/cards/063-pixel-art-16-bit.jpg'},
  { id: '064', type: 'card', name: 'Thermal Blanket', category: 'Material', cost: 1, atk: 0, def: 3, spd: 0, eng: 8, rng: 0, hp: 8,
    effect: 'Material — slot-free. +3 DEF, +8 ENG, +8 HP.', flavor: 'Keeps the heat in — and the enemy out.' , image: 'assets/images/cards/064-pixel-art-16-bit.jpg'},
  { id: '065', type: 'card', name: 'Mirror Polish', category: 'Material', cost: 1, atk: 0, def: 0, spd: 2, eng: 0, rng: 5, hp: 3,
    effect: 'Material — slot-free. +5 RNG, +2 SPD. Reflects laser-based attacks.', flavor: 'So shiny it bounces lasers.' , image: 'assets/images/cards/065-pixel-art-16-bit.jpg'},

  // Hardpoints — Weapons
  { id: '066', type: 'card', name: 'Missile Rack', category: 'Hardpoint · Weapon', cost: 4, atk: 8, def: 0, spd: 0, eng: 0, rng: 5, hp: 0,
    effect: 'Unlocks: Weapon actions. Cannot be dodged.', flavor: 'Locked. Loaded.' , image: 'assets/images/cards/066-pixel-art-16-bit.jpg'},
  { id: '067', type: 'card', name: 'Arc Welder', category: 'Hardpoint · Weapon', cost: 3, atk: 6, def: 0, spd: 1, eng: 2, rng: 1, hp: 1,
    effect: 'Unlocks: Weapon actions. Deals +3 damage to shielded enemies.', flavor: 'Melts through anything conductive.' , image: 'assets/images/cards/067-pixel-art-16-bit.jpg'},
  { id: '068', type: 'card', name: 'Grenade Launcher', category: 'Hardpoint · Weapon', cost: 3, atk: 5, def: 0, spd: 0, eng: 0, rng: 3, hp: 1,
    effect: 'Unlocks: Weapon actions. Splash damage: +2 extra even if blocked.', flavor: 'Close counts.' , image: 'assets/images/cards/068-pixel-art-16-bit.jpg'},
  { id: '069', type: 'card', name: 'Railgun', category: 'Hardpoint · Weapon', cost: 5, atk: 12, def: 0, spd: 0, eng: 0, rng: 8, hp: 0,
    effect: 'Unlocks: Precision, Weapon actions. Requires RNG 7+.', flavor: 'One shot. Through everything.' , image: 'assets/images/cards/069-pixel-art-16-bit.jpg'},
  { id: '070', type: 'card', name: 'Flamethrower', category: 'Hardpoint · Weapon', cost: 3, atk: 4, def: 0, spd: 0, eng: 3, rng: 1, hp: 2,
    effect: 'Unlocks: Weapon actions. Sets enemy on fire — 3 damage per turn for 2 turns.', flavor: 'Burn. Baby. Burn.' , image: 'assets/images/cards/070-pixel-art-16-bit.jpg'},

  // Hardpoints — Defense
  { id: '071', type: 'card', name: 'Point Defense Turret', category: 'Hardpoint · Defense', cost: 3, atk: 2, def: 4, spd: 1, eng: 0, rng: 2, hp: 3,
    effect: 'Unlocks: Defense actions. Auto-attacks enemies that strike first.', flavor: 'Tiny gun, big attitude.' , image: 'assets/images/cards/071-pixel-art-16-bit.jpg'},
  { id: '072', type: 'card', name: 'Smoke Canister', category: 'Hardpoint · Defense', cost: 2, atk: 0, def: 2, spd: 2, eng: 0, rng: 0, hp: 2,
    effect: 'Unlocks: Defense actions. Enemy RNG reduced by 3 for one turn when attacked.', flavor: 'Now they see nothing.' , image: 'assets/images/cards/072-pixel-art-16-bit.jpg'},
  { id: '073', type: 'card', name: 'Ablative Plating', category: 'Hardpoint · Defense', cost: 3, atk: 0, def: 7, spd: 0, eng: 0, rng: 0, hp: 8,
    effect: 'Unlocks: Defense actions. First hit taken each round deals 0 damage.', flavor: 'Sacrifices itself to save you.' , image: 'assets/images/cards/073-pixel-art-16-bit.jpg'},
  { id: '074', type: 'card', name: 'Force Field Generator', category: 'Hardpoint · Defense', cost: 4, atk: 0, def: 5, spd: 0, eng: 5, rng: 0, hp: 4,
    effect: 'Unlocks: Defense actions. Shield actions cost 2 less ENG.', flavor: 'Projects a shimmering wall.' , image: 'assets/images/cards/074-pixel-art-16-bit.jpg'},
  { id: '075', type: 'card', name: 'Chaff Dispenser', category: 'Hardpoint · Defense', cost: 2, atk: 0, def: 1, spd: 3, eng: 0, rng: 0, hp: 1,
    effect: 'Unlocks: Defense actions. Confuses precision targeting — enemy RNG attacks miss 20% of the time.', flavor: 'A cloud of glittering lies.' , image: 'assets/images/cards/075-pixel-art-16-bit.jpg'},

  // Hardpoints — Utility
  { id: '076', type: 'card', name: 'Salvage Claw', category: 'Hardpoint · Repair', cost: 2, atk: 2, def: 1, spd: 1, eng: 3, rng: 0, hp: 3,
    effect: 'Unlocks: Repair actions. Heal 5 HP when you destroy an enemy part (once per round).', flavor: 'Scraps the fallen.' , image: 'assets/images/cards/076-pixel-art-16-bit.jpg'},
  { id: '077', type: 'card', name: 'Overdrive Capacitor', category: 'Hardpoint · Boost', cost: 3, atk: 3, def: 0, spd: 3, eng: 5, rng: 0, hp: 1,
    effect: 'Unlocks: Boost actions. First action each turn costs half ENG (rounded down).', flavor: 'More power. Always more.' , image: 'assets/images/cards/077-pixel-art-16-bit.jpg'},
  { id: '078', type: 'card', name: 'Signal Booster', category: 'Hardpoint · Command', cost: 2, atk: 0, def: 1, spd: 2, eng: 4, rng: 3, hp: 2,
    effect: 'Unlocks: Command actions. Command cards cost 2 less ENG.', flavor: 'Your orders cut through the static.' , image: 'assets/images/cards/078-pixel-art-16-bit.jpg'},
  { id: '079', type: 'card', name: 'Nano Forge', category: 'Hardpoint · Repair', cost: 3, atk: 0, def: 2, spd: 1, eng: 8, rng: 0, hp: 5,
    effect: 'Unlocks: Repair actions. Repair actions heal +8 HP instead of their normal amount.', flavor: 'Builds new parts from thin air.' , image: 'assets/images/cards/079-pixel-art-16-bit.jpg'},
  { id: '080', type: 'card', name: 'Target Painter', category: 'Hardpoint · Precision', cost: 2, atk: 1, def: 0, spd: 1, eng: 0, rng: 4, hp: 1,
    effect: 'Unlocks: Precision actions. Marked enemies take +4 damage from next attack.', flavor: 'Painted red. Dead ahead.' , image: 'assets/images/cards/080-pixel-art-16-bit.jpg'},

  // Hardpoints — Speed
  { id: '081', type: 'card', name: 'Afterburner Pod', category: 'Hardpoint · Speed', cost: 3, atk: 0, def: 0, spd: 6, eng: 2, rng: 0, hp: 0,
    effect: 'Unlocks: Speed actions. Once per round, gain +2 SPD for one turn.', flavor: 'A kick of fire.' , image: 'assets/images/cards/081-pixel-art-16-bit.jpg'},
  { id: '082', type: 'card', name: 'Agility Servos', category: 'Hardpoint · Speed', cost: 2, atk: 1, def: 1, spd: 4, eng: 0, rng: 0, hp: 2,
    effect: 'Unlocks: Speed actions. Reaction window is always open regardless of SPD.', flavor: 'Twitch-fast.' , image: 'assets/images/cards/082-pixel-art-16-bit.jpg'},
  { id: '083', type: 'card', name: 'Jump Jets', category: 'Hardpoint · Speed', cost: 3, atk: 0, def: 0, spd: 5, eng: 4, rng: 2, hp: 1,
    effect: 'Unlocks: Speed actions. Can disengage from melee — next enemy Strike misses.', flavor: 'Up and over.' , image: 'assets/images/cards/083-pixel-art-16-bit.jpg'},
  { id: '084', type: 'card', name: 'Kinetic Battery', category: 'Hardpoint · Engine', cost: 2, atk: 0, def: 0, spd: 2, eng: 8, rng: 0, hp: 2,
    effect: 'Unlocks: Engine actions. Gain +1 ENG every time you take damage.', flavor: 'Pain becomes power.' , image: 'assets/images/cards/084-pixel-art-16-bit.jpg'},
  { id: '085', type: 'card', name: 'Gyro Jets', category: 'Hardpoint · Balance', cost: 2, atk: 1, def: 1, spd: 3, eng: 2, rng: 0, hp: 3,
    effect: 'Unlocks: Balance, Speed actions. Cannot be knocked off balance.', flavor: 'Perfect poise in chaos.' , image: 'assets/images/cards/085-pixel-art-16-bit.jpg'},

  // Hardpoints — Special
  { id: '086', type: 'card', name: 'Clone Projector', category: 'Hardpoint · Command', cost: 4, atk: 2, def: 2, spd: 2, eng: 6, rng: 0, hp: 4,
    effect: 'Unlocks: Command actions. Creates a decoy — next enemy attack has 50% chance to miss.', flavor: 'Which one is real?' , image: 'assets/images/cards/086-pixel-art-16-bit.jpg'},
  { id: '087', type: 'card', name: 'Siphon Module', category: 'Hardpoint · Engine', cost: 3, atk: 1, def: 0, spd: 0, eng: 6, rng: 0, hp: 1,
    effect: 'Unlocks: Engine actions. Drain 3 ENG from enemy when you land a Strike.', flavor: 'Takes their power as your own.' , image: 'assets/images/cards/087-pixel-art-16-bit.jpg'},
  { id: '088', type: 'card', name: 'Frenzy Chip', category: 'Hardpoint · Boost', cost: 3, atk: 4, def: 0, spd: 4, eng: 0, rng: 0, hp: 0,
    effect: 'Unlocks: Boost actions. +2 ATK for every 10 HP missing from your bot.', flavor: 'The more it hurts, the harder it hits.' , image: 'assets/images/cards/088-pixel-art-16-bit.jpg'},
  { id: '089', type: 'card', name: 'Echo Chamber', category: 'Hardpoint · Command', cost: 3, atk: 0, def: 1, spd: 1, eng: 5, rng: 0, hp: 3,
    effect: 'Unlocks: Command actions. Command cards played twice — effect doubled.', flavor: 'Your voice, amplified.' , image: 'assets/images/cards/089-pixel-art-16-bit.jpg'},
  { id: '090', type: 'card', name: 'Doomsday Clock', category: 'Hardpoint · Boost', cost: 5, atk: 10, def: 5, spd: 2, eng: 15, rng: 5, hp: 10,
    effect: 'Unlocks: Boost, Weapon actions. All stats boosted. Once attached, cannot be removed.', flavor: 'Tick. Tock. Boom.' , image: 'assets/images/cards/090-pixel-art-16-bit.jpg'},
