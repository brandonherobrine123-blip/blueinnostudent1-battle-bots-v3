...
window.ASSETS = [
  ...
  { id: '208', type: 'tile', name: 'Overload', category: 'Boost', cost: 7,
    effect: 'Double ATK for one attack this turn. Requires: Boost unlocked.', flavor: 'Run hot, hit harder.' , image: 'assets/images/tiles/208-pixel-art-16-bit.jpg'},
  ...
  { id: '212', type: 'tile', name: 'Last Stand', category: 'Command', cost: 12,
    effect: 'If HP is under 15: deal ATK × 2 and heal 15 HP. Once per fight. Requires: Command unlocked. Min ENG: 25.', flavor: 'Not done yet.' , image: 'assets/images/tiles/212-pixel-art-16-bit.jpg'},
  ...
  { id: '214', type: 'tile', name: 'Barrage', category: 'Weapon', cost: 9,
    effect: 'Deal ATK to all enemy systems. Enemy DEF is halved for this attack. Requires: Weapon unlocked. Min ENG: 18.', flavor: 'Everything. Fire everything.' , image: 'assets/images/tiles/214-pixel-art-16-bit.jpg'},
